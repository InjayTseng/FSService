...
+ (BOOL)nativeAuthorization {
    ...
    FSOAuthStatusCode statusCode = [FSOAuth authorizeUserUsingClientId:key callbackURIString:callbackURL allowShowingAppStore:YES];
